...
Q8 Create a new PersistentVolume name web-pv. It should have a capacity of $CAPACITY, accesMode $ACCESSMODE, hostPath $HOSTPATH and no storageClassName defined.
